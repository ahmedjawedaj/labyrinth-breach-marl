...
\begin{document}
\begin{center}
{\Large\bfseries Labyrinth Breach -- Legacy Viva Cheatsheet} \\[2pt]
{\small AI641 -- AI for Robotics | MS AI, LUMS | May 2025 | Superseded by journal draft}
\end{center}
\vspace{-4pt}
...
Sentinel win rate & 0.750 & 0.689 \\
Runner win rate & 0.250 & 0.311 \\
Escape rate & 0.000 & 0.255 \\
Full capture (s) & 13.33 & 21.04 \\
\bottomrule
\end{tabular}

\textbf{Key takeaway:} This is one-checkpoint diagnostic evidence. Five unseen seed configurations reused one topology and changed other dynamics, so the seen/unseen difference is not a topology effect.

\textbf{Safe claim:} ``The legacy checkpoint executes in both scenes, but controlled multi-seed topology generalization remains untested.''
