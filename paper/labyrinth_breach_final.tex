...
Final outcome rates remain comparable between seen and unseen layouts. Sentinel win rates drop only 1.7 percentage points on unseen mazes, and Runner escape and survival fractions stay within 1 point. The trained policies do not collapse on novel geometry, which indicates that the agents have learned general pursuit and evasion strategies rather than memorizing specific routes.
