...
\title{Labyrinth Breach -- Legacy Implementation Deep Dive}
\subtitle{Superseded May 2025 Course Presentation}
\author{Ahmed Jawed}
...
\midrule
Episodes & 12 & 106 \\
Sentinel WR & 75.0\% & 68.9\% \\
Runner WR & 25.0\% & 31.1\% \\
Escape rate & 0.0\% & 25.5\% \\
Full capture & 13.3s & 21.0s \\
\bottomrule
\end{tabular}

\vspace{6pt}
\textbf{Key insight:}\\
One checkpoint executes in both scenes.\\
The unseen seeds reused one topology and changed other dynamics.\\
\textit{This is not controlled topology-generalization evidence.}

\vspace{4pt}
{\small Safe claim: ``Controlled multi-seed topology generalization remains untested.''}
\end{columns}
\end{frame}
