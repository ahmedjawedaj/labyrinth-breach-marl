...
FINAL_SUMMARY_FIELDS = [
    ...
    "seen_corridor_block_episode_rate",
    "unseen_corridor_block_episode_rate",
    "seen_exit_denial_episode_rate",
    "unseen_exit_denial_episode_rate",
        ...
        seen_row.update(
            {
                ...
                "runner_survival_delta_seconds": seen_row["unseen_survival_time"] - seen_row["seen_survival_time"],
        ...
        seen_unseen_by_seed.append(
            {
                ...
                "seen_pincer_episode_rate": seen_row["seen_pincer_episode_rate"],
                "unseen_pincer_episode_rate": seen_row["unseen_pincer_episode_rate"],
                "seen_corridor_block_episode_rate": seen_row["seen_corridor_block_episode_rate"],
                "unseen_corridor_block_episode_rate": seen_row["unseen_corridor_block_episode_rate"],
                "seen_exit_denial_episode_rate": seen_row["seen_exit_denial_episode_rate"],
                "unseen_exit_denial_episode_rate": seen_row["unseen_exit_denial_episode_rate"],
                ...
                "runner_survival_delta_seconds": seen_row["runner_survival_delta_seconds"],
            ...
            rows.append(
                {
                    ...
                    "enclosure_episode_rate": coord.get("enclosure_episode_rate", ""),
                }
            )
    return rows
...
def main() -> int:
    ...
    write_csv(
        ...
        coordination_rows,
        ["seed", "run_id", "pincer_episode_rate", "corridor_block_episode_rate", "exit_denial_episode_rate", "trap_success_rate", "enclosure_episode_rate"],
    )
    write_csv(
