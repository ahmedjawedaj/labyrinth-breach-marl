            ...
            comp_rows.append(
                {
                    ...
                    "pincer_episode_rate": metric(kpi, "coordination", "pincer_episode_rate"),
                    "corridor_block_episode_rate": metric(kpi, "coordination", "corridor_block_episode_rate"),
                    "exit_denial_episode_rate": metric(kpi, "coordination", "exit_denial_episode_rate"),
                    "route_change_degrees": metric(kpi, "dynamic_route_change_proxy", "mean_abs_heading_change_degrees"),
