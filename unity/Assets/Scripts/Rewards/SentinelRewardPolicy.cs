public sealed class SentinelRewardPolicy
{
    ...
    public float WallLoopPenalty => config.SentinelWallLoopPenalty;
    public float ChaseProgressBonus => config.SentinelChaseProgressBonus;
    public float ChaseRegressionPenalty => config.SentinelChaseRegressionPenalty;
    public float ExplorationVisitBonus => config.SentinelExplorationVisitBonus;
    public float OrbitStallPenalty => config.SentinelOrbitStallPenalty;
